...
namespace SalesManagement_SysDev
{
    public partial class UserControlArrivalDetail : UserControl
    {
        ...
        {
            textBoxArID.Text = dataGridViewOrderDetail.Rows[dataGridViewOrderDetail.CurrentRow.Index].Cells[0].Value.ToString();
            textBoxArDetailID.Text = dataGridViewOrderDetail.Rows[dataGridViewOrderDetail.CurrentRow.Index].Cells[1].Value.ToString();
